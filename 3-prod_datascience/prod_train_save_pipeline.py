...
# Create pipeline
@dsl.pipeline(name="training-pipeline", description="We train an amazing model 🚂")
def training_pipeline(
    ...
    convert_task = convert_keras_to_onnx(
    ...
    kubernetes.use_field_path_as_env(
        model_evaluation_task, env_name="NAMESPACE", field_path="metadata.namespace"
    )
